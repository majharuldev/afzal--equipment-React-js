  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (response.data.success) {
        ...
        //   }
        // }
        navigate("/tramessy/Purchase/fuel");
        reset();
      } else {
            ...
            <div className="md:flex justify-between gap-3">
              ...
              <div className="w-full">
                <SelectField
                  ...
                  options={driverOptions}
                  control={control}
                  defaultValue={watch("driver_name")}
                />
              </div>
              <div className="!w-full">
                ...
                <Controller
                  ...
                  render={({
                    ...
                    <div className="relative">
                      <label
                        htmlFor="bill_image"
                        className="border p-2 rounded  block bg-white text-gray-300 text-sm cursor-pointer"
                      >
